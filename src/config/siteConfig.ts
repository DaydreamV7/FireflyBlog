...
export const siteConfig: SiteConfig = {
	...
	favicon: [
		{
			// 图标文件路径
			src: "/assets/images/dream/Logo-月球与爱心2.ico",
			// 可选，指定主题 'light' | 'dark'
			// theme: "light",
			// 可选，图标大小
			sizes: "32x32",
	...
	navbar: {
		...
		logo: {
			type: "image",
			value: "/assets/images/dream/logo-moonlove.png",
			// alt: "🍀",
		},
		// 导航栏标题
		title: "梦的延续",
	...
	imageOptimization: {
		...
		noReferrerDomains: ["*.hdslb.com", "*.bilibili.com", "cdn.nlark.com",],
	},
